            ...
            <div className="flex justify-between items-start gap-4 pb-4 border-b border-gray-850">
              <div className="flex flex-col gap-1 text-left">
                ...
                <p className="text-[11px] text-slate-400 font-mono">
                  Ajuste plano, domínios, contatos ou envie dicas operacionais personalizadas para serem exibidas no ERP deste cliente.
                </p>
              </div>
              <button
                type="button"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs mt-1">
                  ...
                  {activeCorrectionTab === 'profile' && (
                    <>
                      ...
                      <div className="flex flex-col gap-1.5 sm:col-span-2 bg-[#050912] p-3 rounded-lg border border-purple-950/40 text-left">
                        <label className="text-purple-400 font-mono text-[10px] font-bold uppercase tracking-wider flex items-center gap-1.5">
                          <span>✨ Inteligência Artificial CoPilot</span>
                        </label>
                        <p className="text-[10px] text-gray-400 leading-normal mt-1">
                          Acesso e uso do assistente virtual Gemini integrados de forma <strong>totalmente ilimitada e gratuita</strong>. Sem taxas por volume de tokens ou limites mensais.
                        </p>
                      </div>
                    </>
                  )}
